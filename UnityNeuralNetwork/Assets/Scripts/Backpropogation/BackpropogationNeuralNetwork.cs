...
public class BackporpogationNeuralNetwork
{
    //fundamental 
    ...
    public BackporpogationNeuralNetwork(int[] layers, string[] layerActivations)
    {
    ...
    public int CompareTo(BackporpogationNeuralNetwork other) //Comparing For Genetic implementations. Used for sorting based on the fitness of the network
    {
    ...
    public BackporpogationNeuralNetwork copy(BackporpogationNeuralNetwork nn) //For creatinga deep copy, to ensure arrays are serialzed.
    {
        for (int i = 0; i < biases.Length; i++)
        {
            for (int j = 0; j < biases[i].Length; j++)
